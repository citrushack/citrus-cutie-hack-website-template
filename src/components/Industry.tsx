...
import { filters, professionals } from "@/data/industry";
import type { IndustryType, Professional } from "@/data/industry";
        ...
        {filteredProfessionals.map((person) => (
          ...
          >
            <div className={styles.industryPhoto}>
              {person.image && (
                <Image src={person.image} alt={person.name} fill sizes="74px" />
              )}
            </div>
